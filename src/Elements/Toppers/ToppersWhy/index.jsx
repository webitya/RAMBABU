  ...
  return (
    <div className="bg-gray-100 py-16">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-bold text-gray-800">Why Choose Brajesh Mishra Classes?</h2>
        <p className="text-lg text-gray-600 mt-2">
          Discover the reasons why Brajesh Mishra Classes is the best choice for your academic success.
        </p>
