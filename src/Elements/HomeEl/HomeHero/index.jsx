  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 max-w-lg px-6 py-10 md:px-12 text-white text-center lg:text-left">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Brajesh Mishra Classes</h1>
        ...
        Brajesh Mishra Classes is your gateway to academic excellence. We offer comprehensive coaching for students of all grades. From expert faculty to regular tests, we ensure every student reaches their full potential.
        </p>
